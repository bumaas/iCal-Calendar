...
* iCalcreator (Version 2.41.92) `https://github.com/iCalcreator/iCalcreator/tags`
...
| RegExpression                  | boolean | false                  | Kennzeichnung, ob es sich bei dem Suchmuster um einen regulären Ausdruck ("RegExpr") handelt. <b>Hinweis:</b> Wenn ein Suchmuster als regulärer Ausdruck verwendet wird, wird es vor der Anwendung normalisiert (fehlende Regex-Delimiter werden automatisch ergänzt). |
|
