...
Ein umfangreiches Calendar-Control, das den eigenen Wünschen angepasst werden kann (siehe [Dokumentation](https://fullcalendar.io/docs/)).  
...
1. Kopiere die Dateien `calendar.html` und `feed.php` aus dem Verzeichnis `docs/Examples` in einen Unterordner deines User-Verzeichnisses (z. B. `/user/calendar`).
